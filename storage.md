...
Elegimos RAID 5 porque permite agrupar varios discos físicos para que el sistema los maneje como una sola unidad lógica. En el caso del nivel 5, combina dos cosas: reparte los datos entre los discos (lo que agiliza la lectura y escritura) y, al mismo tiempo, guarda información de paridad que permite reconstruir los datos si un disco falla. En otras palabras, se gana rendimiento sin sacrificar seguridad.
